...
- **Duplicate Check**: ระบบป้องกันเพลงซ้ำ (แจ้งเตือนทันทีถ้ามีในคิวแล้ว)
...
- **Beautiful UI**: อินเตอร์เฟซเรียบหรู พร้อมเอฟเฟกต์เบลอพื้นหลัง
- **Smart Overlay**: ซ่อนชื่อเพลงอัตโนมัติเมื่อวิดีโอเล่น (Cinema Mode)

### 🛠️ ฝั่งแอดมิน (Admin Dashboard)
- **Full Control**: สั่งเล่น, หยุด, ข้าม, ย้อนกลับ, วนซ้ำ ได้ดั่งใจ
- **Queue Management**: ลากจัดเรียงคิวเพลงใหม่ได้ (Drag & Drop) *[Future]* หรือลบเพลงที่ไม่ต้องการ
- **Remote Cinema Trigger**: ปุ่มสั่งขยายจอ Player "🖵" (ไม่ต้องเดินไปกดเอง!)
- **Remote Volume**: ปรับเสียง Player ได้จากหน้าแอดมิน (0-100%) 🔊
- **One-Click Share**: คำสั่งเดียว สร้างลิงก์ออนไลน์ส่งให้เพื่อนได้เลย! 🌐
...
Made with ❤️ by [Your Name] & Antigravity AI
